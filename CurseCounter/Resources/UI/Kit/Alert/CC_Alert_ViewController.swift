...
public class CC_Alert_ViewController : UIViewController {
	...
	public lazy var titleLabel:CC_Label = {
	...
	@discardableResult public static func present(_ error:Error, handler:(()->Void)? = nil) -> CC_Alert_ViewController {
		
		CC_Feedback.shared.make(.Error)
		
		let viewController:CC_Alert_ViewController = .init()
	...
	public static func presentLoading(_ completion:((CC_Alert_ViewController?)->Void)? = nil) {
	...
	@discardableResult public func add(_ string:String?) -> CC_Label {
		
		let label:CC_Label = .init(string)
	...
	@discardableResult public func addButton(sticky:Bool = false, title:String, subtitle:String? = nil,image:UIImage? = nil, _ handler:CC_Button.Handler = nil) -> CC_Button {
		
		let button:CC_Button = .init(title,handler)
	...
	@discardableResult public func addCancelButton(sticky:Bool = false, _ handler:CC_Button.Handler = nil) -> CC_Button {
		
		let button:CC_Button = addButton(sticky:sticky, title: String(key: "alert.cancel.button")) { [weak self] button in
	...
	@discardableResult public func addDismissButton(sticky:Bool = false, _ handler:CC_Button.Handler = nil) -> CC_Button {
		
		let button:CC_Button = addButton(sticky:sticky, title: String(key: "alert.dismiss.button")) { [weak self] button in
...
extension CC_Alert_ViewController : UIScrollViewDelegate {
...
extension CC_Alert_ViewController : UIPopoverPresentationControllerDelegate {
